...
def run_hermes():
    ...
    This mode connects to a running Hermes Desktop instance (http://127.0.0.1:8642)
    and dispatches the cerverus-orchestrator skill to run the full pipeline.
    Falls back to standalone mode if Hermes is not available.
    """
